...
struct qt_meta_stringdata_Breeze__TransitionWidget_t {
    QByteArrayData data[2];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Breeze__TransitionWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Breeze__TransitionWidget_t qt_meta_stringdata_Breeze__TransitionWidget = {
    {
QT_MOC_LITERAL(0, 0, 24), // "Breeze::TransitionWidget"
QT_MOC_LITERAL(1, 25, 7) // "opacity"

    },
    "Breeze::TransitionWidget\0opacity"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Breeze__TransitionWidget[] = {
...
QT_INIT_METAOBJECT const QMetaObject Breeze::TransitionWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Breeze__TransitionWidget.data,
    qt_meta_data_Breeze__TransitionWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Breeze::TransitionWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Breeze__TransitionWidget.stringdata0))
