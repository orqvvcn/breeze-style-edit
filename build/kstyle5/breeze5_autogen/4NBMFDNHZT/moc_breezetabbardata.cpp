...
struct qt_meta_stringdata_Breeze__TabBarData_t {
    QByteArrayData data[3];
    char stringdata0[50];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Breeze__TabBarData_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Breeze__TabBarData_t qt_meta_stringdata_Breeze__TabBarData = {
    {
QT_MOC_LITERAL(0, 0, 18), // "Breeze::TabBarData"
QT_MOC_LITERAL(1, 19, 14), // "currentOpacity"
QT_MOC_LITERAL(2, 34, 15) // "previousOpacity"

    },
    "Breeze::TabBarData\0currentOpacity\0"
    "previousOpacity"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Breeze__TabBarData[] = {
...
QT_INIT_METAOBJECT const QMetaObject Breeze::TabBarData::staticMetaObject = { {
    QMetaObject::SuperData::link<AnimationData::staticMetaObject>(),
    qt_meta_stringdata_Breeze__TabBarData.data,
    qt_meta_data_Breeze__TabBarData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Breeze::TabBarData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Breeze__TabBarData.stringdata0))
