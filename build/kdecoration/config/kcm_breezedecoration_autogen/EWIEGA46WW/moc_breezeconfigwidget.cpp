...
template <> constexpr inline auto Breeze::ConfigWidget::qt_create_metaobjectdata<qt_meta_tag_ZN6Breeze12ConfigWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ConfigWidget, qt_meta_tag_ZN6Breeze12ConfigWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject Breeze::ConfigWidget::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6Breeze12ConfigWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6Breeze12ConfigWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6Breeze12ConfigWidgetE_t>.metaTypes,
    nullptr
} };
...
void *Breeze::ConfigWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6Breeze12ConfigWidgetE_t>.strings))
