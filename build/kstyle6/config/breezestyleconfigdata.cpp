// This file is generated by kconfig_compiler_kf6 from breeze.kcfg.
  ...
  : KConfigSkeleton( QStringLiteral( "breezerc" ) )
{
  ...
  itemWindowDragMode = new KConfigSkeleton::ItemEnum( currentGroup(), QStringLiteral( "WindowDragMode" ), mWindowDragMode, valuesWindowDragMode, WD_MINIMAL );
