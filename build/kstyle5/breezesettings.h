...
class InternalSettings : public KConfigSkeleton
{
  public:
    ...
    enum EnumOutlineIntensity { OutlineOff, OutlineLow, OutlineMedium, OutlineHigh, OutlineMaximum };
    ...
    */
    ...
    /**
      Set OutlineIntensity
    */
    void setOutlineIntensity( int v )
    {
      if (!isOutlineIntensityImmutable())
        mOutlineIntensity = v;
    }
    ...
    */
    int outlineIntensity() const
    {
      return mOutlineIntensity;
    }

    /**
      Is OutlineIntensity Immutable
    */
    bool isOutlineIntensityImmutable() const
    {
      return isImmutable( QStringLiteral( "OutlineIntensity" ) );
    }
