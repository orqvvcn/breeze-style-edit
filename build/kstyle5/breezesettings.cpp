  ...
  : KConfigSkeleton( QStringLiteral( "breezerc" ) )
{
  ...
  QList<KConfigSkeleton::ItemEnum::Choice> valuesOutlineIntensity;
  {
    KConfigSkeleton::ItemEnum::Choice choice;
    choice.name = QStringLiteral("OutlineOff");
    valuesOutlineIntensity.append( choice );
  }
  {
    KConfigSkeleton::ItemEnum::Choice choice;
    choice.name = QStringLiteral("OutlineLow");
    valuesOutlineIntensity.append( choice );
  }
  {
    KConfigSkeleton::ItemEnum::Choice choice;
    choice.name = QStringLiteral("OutlineMedium");
    valuesOutlineIntensity.append( choice );
  }
  {
    KConfigSkeleton::ItemEnum::Choice choice;
    choice.name = QStringLiteral("OutlineHigh");
    valuesOutlineIntensity.append( choice );
  }
  {
    KConfigSkeleton::ItemEnum::Choice choice;
    choice.name = QStringLiteral("OutlineMaximum");
    valuesOutlineIntensity.append( choice );
  }
  KConfigSkeleton::ItemEnum  *itemOutlineIntensity;
  itemOutlineIntensity = new KConfigSkeleton::ItemEnum( currentGroup(), QStringLiteral( "OutlineIntensity" ), mOutlineIntensity, valuesOutlineIntensity, OutlineMedium );
  addItem( itemOutlineIntensity, QStringLiteral( "OutlineIntensity" ) );
