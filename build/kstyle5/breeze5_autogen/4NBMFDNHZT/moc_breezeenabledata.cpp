...
struct qt_meta_stringdata_Breeze__EnableData_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Breeze__EnableData_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Breeze__EnableData_t qt_meta_stringdata_Breeze__EnableData = {
    {
QT_MOC_LITERAL(0, 0, 18) // "Breeze::EnableData"
...
static const uint qt_meta_data_Breeze__EnableData[] = {
...
QT_INIT_METAOBJECT const QMetaObject Breeze::EnableData::staticMetaObject = { {
    QMetaObject::SuperData::link<WidgetStateData::staticMetaObject>(),
    qt_meta_stringdata_Breeze__EnableData.data,
    qt_meta_data_Breeze__EnableData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Breeze::EnableData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Breeze__EnableData.stringdata0))
