...
namespace {
struct qt_meta_tag_ZN6Breeze13ScrollBarDataE_t {};
} // unnamed namespace

template <> constexpr inline auto Breeze::ScrollBarData::qt_create_metaobjectdata<qt_meta_tag_ZN6Breeze13ScrollBarDataE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "Breeze::ScrollBarData",
        "clearAddLineRect",
        "",
        "clearSubLineRect",
        "addLineOpacity",
    ...
    return QtMocHelpers::metaObjectData<ScrollBarData, qt_meta_tag_ZN6Breeze13ScrollBarDataE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Breeze::ScrollBarData::staticMetaObject = { {
    QMetaObject::SuperData::link<WidgetStateData::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6Breeze13ScrollBarDataE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6Breeze13ScrollBarDataE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6Breeze13ScrollBarDataE_t>.metaTypes,
    nullptr
} };
...
void *Breeze::ScrollBarData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6Breeze13ScrollBarDataE_t>.strings))
